package com.assist.view.info
{
    ...
    public class ServerWarInfo extends Object
    {
        ...
        public function ServerWarInfo(param1:int = 0)
        {
        ...
        public function get cupMsg() : String
        {
            ...
            switch(this.stateServer)
            {
                case this.STEP_DIBANG_COMPLETE():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.WillGoon, this.getTime_MDHI_AtState(this.STEP_16()), this.getSerStateName(this.stateServer, this.groupCup));
                    break;
                }
                case this.STEP_16_COMPLETE():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.WillGoon, this.getTime_MDHI_AtState(this.STEP_8()), this.getSerStateName(this.stateServer, this.groupCup));
                    break;
                }
                case this.STEP_8_COMPLETE():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.WillGoon, this.getTime_MDHI_AtState(this.STEP_4()), this.getSerStateName(this.stateServer, this.groupCup));
                    break;
                }
                case this.STEP_4_COMPLETE():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.WillGoon, this.getTime_MDHI_AtState(this.STEP_2()), this.getSerStateName(this.stateServer, this.groupCup));
                    break;
                }
                case this.STEP_2_COMPLETE():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.WillGoon, this.getTime_MDHI_AtState(this.STEP_1()), this.getSerStateName(this.stateServer, this.groupCup));
                    break;
                }
                case this.STEP_16():
                case this.STEP_8():
                ...
                case this.STEP_1():
                {
                    _loc_1 = Lang.sprintf(ServerWarInfoLang.InGoon, this.getGroupName(this.groupCup), this.getSerStateName(this.stateServer, 0));
                    break;
                }
                default:
                {
        ...
        public function setCupRoundWar(param1:Array) : void
        {
            ...
            var _loc_3:Array = [ServerWarInfoLang.Ju1, ServerWarInfoLang.Ju2, ServerWarInfoLang.Ju3, ServerWarInfoLang.Ju4, ServerWarInfoLang.Ju5];
            ...
            for each (_loc_5 in param1)
            {
                ...
                {
                    _loc_7++;
                    _loc_4[_loc_6] = HtmlText.white(linkText(ServerWarInfoLang.Win, ["war", _loc_5[1], _loc_5[2]]));
                }
                else if (_loc_5[0] == 2)
                {
                    _loc_4[_loc_6] = HtmlText.red(linkText(ServerWarInfoLang.UnWin, ["war", _loc_5[1], _loc_5[2]]));
                    _loc_7 = _loc_7 - 1;
                }
                _loc_6++;
            }
            if (_loc_6 >= 3 && (_loc_7 >= 3 || _loc_7 <= -3))
            {
                while (_loc_6 < 5)
                {
                    ...
                    _loc_3[_loc_6] = HtmlText.white(_loc_3[_loc_6]);
                    _loc_4[_loc_6] = HtmlText.white(ServerWarInfoLang.Over);
                    _loc_6++;
                }
            }
        ...
        private function getTime_MDHI_AtState(param1:int) : String
        {
            ...
            {
                return ServerWarInfoLang.Today + _loc_3[2] + ":" + _loc_3[3];
            }
            _loc_4.time = _loc_4.time + 24 * 3600000;
            if (_loc_4.date == _loc_3[1])
            {
                return ServerWarInfoLang.Tomorrow + _loc_3[2] + ":" + _loc_3[3];
            }
            return _loc_3[0] + ServerWarInfoLang.Moth + _loc_3[1] + ServerWarInfoLang.Day + " " + _loc_3[2] + ":" + _loc_3[3];
        }// end function
        ...
        public function getSerStateName(param1:int, param2:int) : String
        {
            ...
            switch(param1)
            {
                ...
                {
                    _loc_3 = ServerWarInfoLang.TianBangKnockout;
                    break;
                }
                case this.STEP_DIBANG():
                {
                    _loc_3 = ServerWarInfoLang.DiBangKnockout;
                    break;
                }
                case this.STEP_DIBANG_COMPLETE():
                case this.STEP_16():
                {
                    _loc_3 = this.getGroupName(param2) + ServerWarInfoLang.War16;
                    break;
                }
                case this.STEP_16_COMPLETE():
                case this.STEP_8():
                {
                    _loc_3 = this.getGroupName(param2) + ServerWarInfoLang.War8;
                    break;
                }
                case this.STEP_8_COMPLETE():
                case this.STEP_4():
                {
                    _loc_3 = this.getGroupName(param2) + ServerWarInfoLang.War4;
                    break;
                }
                case this.STEP_4_COMPLETE():
                case this.STEP_2():
                {
                    _loc_3 = this.getGroupName(param2) + ServerWarInfoLang.War2;
                    break;
                }
                case this.STEP_2_COMPLETE():
                case this.STEP_1():
                {
                    _loc_3 = this.getGroupName(param2) + ServerWarInfoLang.War1;
                    break;
                }
                default:
                {
        ...
        public function setCupCanBet(param1:Array) : void
        {
            ...
            for each (_loc_2 in param1)
            {
                ...
                this.cupCanBetList.push({label:int(_loc_2[0] / 10000) + ServerWarInfoLang.Wang, num:int(_loc_2[0])});
            }
            return;
        }// end function
        ...
        public function setCupGuessList(param1:Array) : void
        {
            ...
            if (_loc_2 != 0)
            {
                _loc_6 = _loc_2 / 10000 + ServerWarInfoLang.Wang + ServerWarInfoLang.Coin;
            }
            else
            {
                _loc_6 = _loc_2 / 10000 + ServerWarInfoLang.Coin;
            }
            if (_loc_3 != 0)
            {
                _loc_7 = Math.abs(_loc_3 / 10000) + ServerWarInfoLang.Wang + ServerWarInfoLang.Coin;
            }
            else
            {
                _loc_7 = "0" + ServerWarInfoLang.Coin;
            }
            _loc_6 = HtmlText.yellow2(_loc_6);
            _loc_7 = _loc_3 >= 0 ? (HtmlText.green(_loc_7)) : (HtmlText.red(_loc_7));
            if (_loc_3 > 0)
            {
                this.cupGuessTip = Lang.sprintf(ServerWarInfoLang.GuessAllTip1, HtmlText.yellow(param1.length + ""), _loc_6, _loc_7);
            }
            else
            {
                this.cupGuessTip = Lang.sprintf(ServerWarInfoLang.GuessAllTip2, HtmlText.yellow(param1.length + ""), _loc_6, _loc_7);
            }
            return;
        }// end function
        ...
        public function setBetRank(param1:Array) : void
        {
            ...
            for each (_loc_3 in param1)
            {
                ...
                {
                    _loc_5 = int(_loc_6 / 100000000) + ServerWarInfoLang.Yi;
                }
                else if (_loc_6 >= 10000)
                {
                    _loc_5 = int(_loc_6 / 10000) + ServerWarInfoLang.Wang;
                }
                _loc_7 = "";
                if (this.isCrossService)
                {
                    _loc_7 = Lang.sprintf(ServerWarInfoLang.From, _loc_3[2], _loc_3[3]);
                }
