package com.assist.view
{
    ...
    public class TimeChange extends Object
    {
        ...
        public static function timerInfo(param1:Number, param2:Number, param3:String = "Current") : String
        {
            ...
            var _loc_5:* = (param2 - param1) / 86400;
            ...
            if (_loc_5 >= 2 && _loc_5 < 7)
            {
                return Lang.sprintf(TimeChangeLang.DaysAgo, _loc_5);
            }
            if (_loc_5 >= 1)
            {
            ...
            if (_loc_6 >= 1)
            {
                return Lang.sprintf(TimeChangeLang.HoursAgo, _loc_6);
            }
            if (_loc_7 >= 30)
            {
            ...
            return Lang.sprintf(TimeChangeLang.MinutesAgo, _loc_7);
        }// end function
        ...
        public static function diffTimerInfo(param1:Number, param2:Number) : Object
        {
            ...
            var _loc_5:* = new Date(param2 * 1000).getDate() - _loc_3.getDate();
