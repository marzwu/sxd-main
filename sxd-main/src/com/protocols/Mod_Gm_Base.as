package com.protocols
{
    ...
    public class Mod_Gm_Base extends Object
    {
        ...
        public static const get_remain_submit_times:Object = {module:76, action:184, request:[], response:[Utils.ByteUtil]};
        public static const submit_bug:Object = {module:76, action:64, request:[Utils.ByteUtil, Utils.StringUtil], response:[Utils.ByteUtil, Utils.ByteUtil]};
        public static const get_bug_list:Object = {module:76, action:199, request:[], response:[[Utils.StringUtil, Utils.StringUtil]]};
