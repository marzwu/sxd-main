package com.datas
{
    ...
    public class ServerFactionWarData extends Base
    {
        public var info:ServerFactionWarInfo;
        public var result:int = 0;
        public var signupState:int = 0;
        public var dieoutTip:String = "";
        public var dieoutWarList:Array;

        public function ServerFactionWarData() : void
        {
            this.info = new ServerFactionWarInfo();
            this.dieoutWarList = [];
            return;
        }// end function
        ...
        public function get_race_step(param1:Array) : void
        {
            ...
            this.info.warType = Mod_ServerFactionWar_Base.RACE_TYPE_STAGE_SELECT_RACE;
            ...
            if (this.info.groupCup == Mod_ServerFactionWar_Base.GROUP_NULL)
            {
            ...
            this.dieoutTip = "";
            if (_loc_2.race_step == Mod_ServerFactionWar_Base.SERVER_WAR_TIANBANG)
            {
                this.dieoutTip = Lang.sprintf(ServerFactionWarDataLang.TianBangRoundIdx, _loc_2.war_round, _loc_2.player_number);
                this.dieoutTip = HtmlText.green(this.dieoutTip);
            }
            else if (_loc_2.race_step == Mod_ServerFactionWar_Base.SERVER_WAR_DIBANG)
            {
                this.dieoutTip = Lang.sprintf(ServerFactionWarDataLang.DiBangRoundIdx, _loc_2.war_round, _loc_2.player_number);
                this.dieoutTip = HtmlText.green(this.dieoutTip);
            }
            return;
        }// end function
        ...
        public function get_standings(param1:Array) : void
        {
            ...
            var _loc_2:String = "";
            this.dieoutTip = "";
            if (param1[0] == Mod_ServerFactionWar_Base.SERVER_WAR_TIANBANG)
            {
                _loc_2 = ServerFactionWarDataLang.TianBangRound;
                this.dieoutTip = Lang.sprintf(ServerFactionWarDataLang.TianBangRoundIdx, param1[1], param1[2]);
            }
            else if (param1[0] == Mod_ServerFactionWar_Base.SERVER_WAR_DIBANG)
            {
                _loc_2 = ServerFactionWarDataLang.DiBangRound;
                this.dieoutTip = Lang.sprintf(ServerFactionWarDataLang.DiBangRoundIdx, param1[1], param1[2]);
            }
            if (this.dieoutTip != "")
            {
                if (param1[4] == 1)
                {
                    this.dieoutTip = HtmlText.green(ServerFactionWarDataLang.Into32) + this.dieoutTip;
                    _loc_2 = ServerFactionWarDataLang.TianBangRound;
                }
                else if (param1[4] == 2)
                {
                    this.dieoutTip = HtmlText.red(this.dieoutTip + ServerFactionWarDataLang.Out);
                }
                this.dieoutTip = HtmlText.green(this.dieoutTip);
                if (this.info.groupCup == Mod_ServerFactionWar_Base.GROUP_TIAN_BANG && this.info.warType == Mod_ServerFactionWar_Base.RACE_TYPE_STAGE_RACE)
                {
                    _loc_2 = ServerFactionWarDataLang.TianBangRound;
                    this.dieoutTip = HtmlText.green(ServerFactionWarDataLang.Into32) + this.dieoutTip;
                }
            ...
            for each (_loc_4 in param1[5])
            {
                ...
                if (_loc_4[2] == 1)
                {
                    ...
                    _loc_5.win = HtmlText.white(this.linkText(ServerFactionWarDataLang.Win, ["war", _loc_4[3], _loc_4[4]]));
                }
                else
                {
                    _loc_5.mark = HtmlText.red("0:1");
                    _loc_5.win = HtmlText.red(this.linkText(ServerFactionWarDataLang.NoWin, ["war", _loc_4[3], _loc_4[4]]));
                }
        ...
        public function get_race_list(param1:Array) : void
        {
            ...
            _loc_6 = this.info.stateServer != Mod_ServerFactionWar_Base.SERVER_WAR_1_COMPLETE ? ([0]) : ([_loc_2.top_1]);
        ...
        public function get_race_standings(param1:Array) : void
        {
            ...
            for each (_loc_6 in _loc_5)
            {
                ...
                this.info.pushRecord(_loc_6[0], _loc_6[1], _loc_6[2], _loc_6[3], _loc_6[4], _loc_6[5], _loc_6[6] + Lang.sprintf(ServerFactionWarDataLang.RoundIdx, _loc_3));
                _loc_3 = _loc_3 - 1;
            }
        ...
        {
            if (this.info.warType == Mod_ServerFactionWar_Base.RACE_TYPE_STAGE_RACE && param2[0] == "player")
            {
                return param1;
            }
