package com.views
{
    ...
    public class CampWarView extends Base implements IView
    {
        ...
        public function updateSkill(param1:int) : void
        {
            ...
            {
                this._campWar.updateSkill(param1);
            }
            return;
        }// end function
        ...
        private function loadDataCallBack() : void
        {
            ...
            {
                var _loc_1:* = _ctrl.campWar.getCurrentCampOpenTime();
                var _loc_2:* = _ctrl.campWar.getIsOpenCampWar();
                _view.activities.activityShowCampWar(_loc_2, _loc_1["start_time"], _loc_1["end_time"]);
        ...
        private function renderPlayerAndWarReport() : void
        {
            ...
            else if (this._ctrl.campWar.getPlayerStatusDataLength > 0)
            {
            ...
            else if (this._ctrl.campWar.getWarReportLength > 0)
            {
        ...
        private function updatePlayerStatus(param1:Array) : void
        {
            ...
            for each (_loc_4 in param1)
            {
                ...
                if (_loc_4["camp_id"] == FactionType.campId(FactionType.ShuShanCheng))
                {
        ...
        private function updateShuShanPlayerStatus(param1:Object) : void
        {
            var _loc_3:int = 0;
            var _loc_2:Object = {};
            if (param1["status"] == Mod_CampWar_Base.PLAYER_JOIN_CAMP_WAR)
            {
            ...
            else if (param1["status"] == Mod_CampWar_Base.PLAYER_EXIT_CAMP_WAR)
            {
            ...
            this._campWar.renderPlayer(param1, FactionType.ShuShanCheng);
            return;
        }// end function
        ...
        private function updateKunLunPlayerStatus(param1:Object) : void
        {
            ...
            this._campWar.renderPlayer(param1, FactionType.KunLunCheng);
            return;
        }// end function
        ...
        private function updateWarReport(param1:Array) : void
        {
            ...
            else if (this._campWar.WarReportType == 1)
            {
                this._campWar.renderWarReport(this._aryWarReport, this._aryPlayerWarReport, param1);
            }
            ...
            else if (this._campWar.WarReportType == 0)
            {
                this._campWar.renderWarReport(this._aryWarReport, this._aryPlayerWarReport, param1);
            }
            return;
        ...
        {
            var _loc_1:* = this._ctrl.campWar.getCurrentCampOpenTime();
            var _loc_2:* = this._ctrl.campWar.getIsOpenCampWar();
        ...
        {
            this.isShowUI();
            var _loc_1:* = this._ctrl.campWar.openCampWar();
            this._campWar.renderWinningList(_loc_1);
            this._campWar.renderIntegral(_loc_1);
            this._campWar.renderPlayerCampWarInfo(_loc_1);
            return;
        }// end function
        ...
        {
            this.isShowUI();
            var _loc_1:* = this._ctrl.campWar.getCampLevelArea();
            this._campWar.renderCampLevelArea(_loc_1);
        ...
        private function join_camp_war(param1:Boolean) : void
        {
            if (param1)
            {
        ...
        {
            var _loc_1:* = this._ctrl.campWar.getJoinCampWar();
            if (_loc_1["result"] == Mod_CampWar_Base.SUCCESS)
            {
            ...
            this._campWar.renderJoinWar(_loc_1["result"]);
            return;
        }// end function
        ...
        {
            var objPlayerCampInfo:Object;
            var objIntegral:Object;
            var obj:* = param1;
        ...
        private function buy_buff(param1:int) : void
        {
            ...
            this._data.call(Mod_CampWar_Base.buy_buff, this.buyBuffCallBack, [param1]);
            return;
        }// end function

        private function buyBuffCallBack() : void
        {
            var _loc_1:* = this._ctrl.campWar.buyBuff();
            if (_loc_1["result"] == Mod_CampWar_Base.SUCCESS)
            {
                ...
                {
                    this._campWar.renderBuyBuffSuccess(Lang.sprintf(CampWarViewLang.InspireSuccess, _loc_1["add_buff_value"]));
                    this._campWar.renderBuff(_loc_1);
                    this._view.toolbar.updateCampWarInspire(_loc_1["buff_value"]);
                }
            }
            else if (_loc_1["result"] == Mod_CampWar_Base.NOT_ENOUGH_INGOT)
            {
                _view.showTip(this.message(_loc_1.result));
            }
            else
            {
                this._campWar.renderBuyBuffFail(this.message(_loc_1["result"]));
            }
            this._blnInBuyBuff = false;
            return;
        }// end function
        ...
        {
            var _loc_1:* = this._ctrl.campWar.getBuff();
            this._view.toolbar.updateCampWarInspire(_loc_1["buff_value"]);
            if (this._campWar != null)
            {
                this._campWar.renderBuff(_loc_1);
        ...
        {
            this._data.call(Mod_CampWar_Base.set_robot, this.setRobotCallBack, [param1 == true ? (Mod_CampWar_Base.ON) : (Mod_CampWar_Base.OFF)]);
            return;
        }// end function

        private function setRobotCallBack() : void
        {
            var _loc_1:* = this._ctrl.campWar.setRobot();
            if (_loc_1["result"] != Mod_CampWar_Base.SUCCESS)
            {
        ...
        private function message(param1:int) : String
        {
            ...
            switch(param1)
            {
                ...
                {
                    _loc_2 = CampWarViewLang.Success;
                    break;
                }
                case Mod_CampWar_Base.CD_TIME:
                {
                    _loc_2 = CampWarViewLang.CdTime;
                    break;
                }
                case Mod_CampWar_Base.NOT_ENOUGH_INGOT:
                {
                    _loc_2 = CampWarViewLang.NotEnoughIngot;
                    break;
                }
                case Mod_CampWar_Base.NOT_ENOUGH_SKILL:
                {
                    _loc_2 = CampWarViewLang.NotEnoughSkill;
                    break;
                }
                case Mod_CampWar_Base.MAX_BUFF:
                {
                    _loc_2 = CampWarViewLang.MaxBuff;
                    break;
                }
                case Mod_CampWar_Base.REQUEST_VIP_LEVEL:
                {
                    _loc_2 = CampWarViewLang.RequestVipLevel;
                    break;
                }
                case Mod_CampWar_Base.IN_ACTION:
                {
                    _loc_2 = CampWarViewLang.InAction;
                    break;
                }
                default:
                {
                    _loc_2 = CampWarViewLang.Error + param1;
                    break;
                }
            }
            return _loc_2;
