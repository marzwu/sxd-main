package com.views
{
    ...
    final public class ServerWarCupView extends Base implements IView
    {
        private var _info:ServerWarInfo;
        private var _target:IServerWarCup;
        private var _linkData:Array;
        private var _timerProcess:String = "ServerWarCupView_timerProcess";
        ...
        private function onSee(param1:int, param2:int, param3:int) : void
        {
            switch(param3)
            {
                case 16:
                {
                    this.get_war_result_list(param1, param2, Mod_ServerWar_Base.SERVER_WAR_16);
                    break;
                }
                case 8:
                {
                    this.get_war_result_list(param1, param2, Mod_ServerWar_Base.SERVER_WAR_8);
                    break;
                }
                case 4:
                {
                    this.get_war_result_list(param1, param2, Mod_ServerWar_Base.SERVER_WAR_4);
                    break;
                }
                case 2:
                {
                    this.get_war_result_list(param1, param2, Mod_ServerWar_Base.SERVER_WAR_2);
                    break;
                }
                case 1:
                {
                    this.get_war_result_list(param1, param2, Mod_ServerWar_Base.SERVER_WAR_1);
                    break;
                }
                default:
                {
        ...
        private function onBet(param1:int, param2:int) : void
        {
            ...
            {
                _view.alert.showYesNoMsg(Lang.sprintf(ServerWarCupViewLang.BetTip, this._info.getUserData(id).name, HtmlText.yellow2("" + int(num / 10000))), ServerWarCupViewLang.Yes, ServerWarCupViewLang.No, function (param1:int) : void
            {
        ...
        public function set renderIngot(param1:Number) : void
        {
            ...
            this.onTip(_loc_2, ServerWarCupViewLang.Ingot + param1);
        ...
        public function set renderCoins(param1:Number) : void
        {
            ...
            this.onTip(_loc_2, ServerWarCupViewLang.Coin + param1);
            if (int(_loc_2.text) > param1)
            {
        ...
        private function onLink(event:TextEvent) : void
        {
            ...
            else if (this._linkData[0] == "player")
            {
                ...
                _loc_2 = [ServerWarCupViewLang.See, ServerWarCupViewLang.Add, ServerWarCupViewLang.Send, ServerWarCupViewLang.Talk];
        ...
        private function get_race_list(param1:int) : void
        {
            ...
            _data.call(Mod_ServerWar_Base.get_race_list, this.get_race_list_back, [param1, Mod_ServerWar_Base.WORLD_WAR_LEVEL_NULL]);
        ...
        {
            _data.call(Mod_ServerWar_Base.get_war_result_list, this.get_war_result_list_back, [param1, param2, param3]);
            return;
        }// end function
        ...
        {
            _data.call(Mod_ServerWar_Base.bet, this.bet_back, [this._info.betState, param1, param2]);
            return;
        }// end function
